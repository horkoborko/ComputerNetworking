...
class WebServer {
  ...
  static void loadProps() throws IOException {
    String fileString = System.getProperty("user.dir") + File.separator + "config" + File.separator
    ...
    if (file.exists()) {
      ...
      if (propertyString != null) {
        ...
        log = new PrintStream(new BufferedOutputStream(new FileOutputStream(propertyString)));
      } else {
        log = System.out;
      }
    }
